...
@Service
public class SeatCrudServiceOLD extends AbstractCrudServiceOLD<Seat, SeatServiceDTO, SeatRepository> {

    private static final Logger logger = LoggerFactory.getLogger(SeatCrudServiceOLD.class);

    private final TournamentRepository tournamentRepository;
    private final PlayerRepository playerRepository;

    public SeatCrudServiceOLD(SeatRepository repository, TournamentRepository tournamentRepository, PlayerRepository playerRepository) {
        super(repository);
