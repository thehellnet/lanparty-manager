...
@RestController
@CrossOrigin(origins = "*")
@RequestMapping(path = "/api/public/v1/crud/tournament")
public class TournamentCrudController {
    ...
    @CheckToken
    @CheckRoles(Role.TOURNAMENT_CREATE)
    @RequestMapping(
    ...
    @CheckToken
    @CheckRoles(Role.TOURNAMENT_READ)
    @RequestMapping(
            path = "{id}",
    ...
    @CheckToken
    @CheckRoles(Role.TOURNAMENT_UPDATE)
    @RequestMapping(
            path = "{id}",
    ...
    @CheckToken
    @CheckRoles(Role.TOURNAMENT_DELETE)
    @RequestMapping(
            path = "{id}",
