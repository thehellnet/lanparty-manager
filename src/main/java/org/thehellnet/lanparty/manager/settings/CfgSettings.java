...
public class CfgSettings {
    ...
    public static final ParsedCfgCommand[] INITIALS_ARRAY = new ParsedCfgCommand[]{
            UNBINDALL
    };

    public static final ParsedCfgCommand[] FINALS_ARRAY = new ParsedCfgCommand[]{
            BIND_QUIT,
            BIND_EXEC,
            BIND_DUMP
    };

    public static final ParsedCfgCommand[] MINIMAL_ARRAY = ArrayUtils.addAll(INITIALS_ARRAY, FINALS_ARRAY);
    public static final ParsedCfgCommand[] SPECIALS_ARRAY = ArrayUtils.addAll(MINIMAL_ARRAY, NAME);
