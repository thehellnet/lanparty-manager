...
public class CfgConstant {
    ...
    private static final ParsedCfgCommand[] INITIALS_ARRAY = new ParsedCfgCommand[]{UNBINDALL};
    private static final ParsedCfgCommand[] FINALS_ARRAY = new ParsedCfgCommand[]{BIND_EXEC, BIND_DUMP};
