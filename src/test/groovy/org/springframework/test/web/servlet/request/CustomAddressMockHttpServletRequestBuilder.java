...
public class CustomAddressMockHttpServletRequestBuilder implements ConfigurableSmartRequestBuilder<CustomAddressMockHttpServletRequestBuilder>, Mergeable {
     ...
     */
    CustomAddressMockHttpServletRequestBuilder(HttpMethod httpMethod, String url, Object... vars) {
        this(httpMethod.name(), UriComponentsBuilder.fromUriString(url).buildAndExpand(vars).encode().toUri());
    }

    /**
     * Alternative to {@link #CustomAddressMockHttpServletRequestBuilder(HttpMethod, String, Object...)}
     ...
     * @since 4.0.3
     */
    CustomAddressMockHttpServletRequestBuilder(HttpMethod httpMethod, URI url) {
     ...
     * @since 4.3
     */
    CustomAddressMockHttpServletRequestBuilder(String httpMethod, URI url) {
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder contextPath(String contextPath) {
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder servletPath(String servletPath) {
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder pathInfo(@Nullable String pathInfo) {
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder secure(boolean secure) {
        this.secure = secure;
        return this;
    }
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder characterEncoding(String encoding) {
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder content(byte[] content) {
     ...
     * @param content the body content
     */
    public CustomAddressMockHttpServletRequestBuilder content(String content) {
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder contentType(MediaType contentType) {
     ...
     * @since 4.1.2
     */
    public CustomAddressMockHttpServletRequestBuilder contentType(String contentType) {
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder accept(MediaType... mediaTypes) {
     ...
     * @param mediaTypes one or more media types
     */
    public CustomAddressMockHttpServletRequestBuilder accept(String... mediaTypes) {
        Assert.notEmpty(mediaTypes, "'mediaTypes' must not be empty");
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder header(String name, Object... values) {
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder headers(HttpHeaders httpHeaders) {
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder param(String name, String... values) {
     ...
     * @since 4.2.4
     */
    public CustomAddressMockHttpServletRequestBuilder params(MultiValueMap<String, String> params) {
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder cookie(Cookie... cookies) {
     ...
     * @since 4.3.6
     */
    public CustomAddressMockHttpServletRequestBuilder locale(Locale... locales) {
     ...
     * @see #locale(Locale...)
     */
    public CustomAddressMockHttpServletRequestBuilder locale(@Nullable Locale locale) {
        this.locales.clear();
        if (locale != null) {
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder requestAttr(String name, Object value) {
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder sessionAttr(String name, Object value) {
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder sessionAttrs(Map<String, Object> sessionAttributes) {
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder flashAttr(String name, Object value) {
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder flashAttrs(Map<String, Object> flashAttributes) {
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder session(MockHttpSession session) {
     ...
     */
    public CustomAddressMockHttpServletRequestBuilder principal(Principal principal) {
     ...
     */
    @Override
    public CustomAddressMockHttpServletRequestBuilder with(RequestPostProcessor postProcessor) {
    ...
    public Object merge(@Nullable Object parent) {
        ...
        if (!(parent instanceof CustomAddressMockHttpServletRequestBuilder)) {
            throw new IllegalArgumentException("Cannot merge with [" + parent.getClass().getName() + "]");
        }
        CustomAddressMockHttpServletRequestBuilder parentBuilder = (CustomAddressMockHttpServletRequestBuilder) parent;
